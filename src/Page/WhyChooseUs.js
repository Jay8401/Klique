  ...
  return (
    <div ref={ref} className={`mt-16 ${isVisible ? "animate" : ""}`}>
      <h2 className="text-3xl mb-6 text-center text-pink-400 font-bold">
        Why choose <span className="font-galada">us?</span>
      </h2>
      <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
        <div className="card bg-[#D0E655] font-semibold text-black p-6 rounded-lg w-full sm:w-1/2 lg:w-1/4 text-center">
